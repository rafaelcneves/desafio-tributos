...
class SalesController extends AppController
{
    ...
    public function add()
    {
        ...
        if ($this->request->is('post')) {
            ...
            if ($this->Sales->save($sale)) {
                $this->Flash->success('The sale has been saved.');
                return $this->redirect(['action' => 'index']);
            } else {
                $this->Flash->error('The sale could not be saved. Please, try again.');
            }
        }
    ...
    public function delete($id = null)
    {
        ...
        if ($this->Sales->delete($sale)) {
            $this->Flash->success('The sale has been deleted.');
        } else {
            $this->Flash->error('The sale could not be deleted. Please, try again.');
        }
        return $this->redirect(['action' => 'index']);
    }
}
